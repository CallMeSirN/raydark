...
banner() {
	cat <<- EOF
		${ORANGE}
		${BLUE} 𝑹𝑨𝒀𝑫𝑨𝑹𝑲        ${RED}Version : 2.2

		${GREEN}[${WHITE}-${GREEN}]${CYAN} Tool Created by Sloth and (For education)${WHITE}
	EOF
}
...
about() {
	{ clear; banner; echo; }
	cat <<- EOF
		${GREEN}Author   ${RED}: ${ORANGE} N ${RED}
		
		${GREEN}Social   ${RED}:  ${CYAN} 𝘕˞#4273
		${GREEN}Version  ${RED}:  ${ORANGE}2.2

		${REDBG}${WHITE} Thanks to: Lmb, Sislovesme, cbangbang ${RESETBG}
